...
(
  ...
  STATUS VARCHAR2(20) CHECK (STATUS IN ('user', 'admin')) NOT NULL,
  IS_ACTIVE VARCHAR2(20) CHECK (IS_ACTIVE IN ('active', 'unactivated')) NOT NULL ,
  IS_BANED VARCHAR2(20) CHECK  (IS_BANED IN ('baned', 'unbanned')) NOT NULL
);
